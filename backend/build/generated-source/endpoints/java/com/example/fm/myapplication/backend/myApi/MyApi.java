 ...
 * on 2015-10-18 at 01:03:09 UTC 
 * Modify at your own risk.
 */

package com.example.fm.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://build-it-bigger-1101.appspot.com/_ah/api/";
  ...
  public class GetJokes extends MyApiRequest<com.example.fm.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJokes() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.fm.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.fm.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.fm.myapplication.backend.myApi.model.MyBean.class);
  ...
  /**
   * Create a request for the method "thisNotAJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link ThisNotAJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public ThisNotAJoke thisNotAJoke() throws java.io.IOException {
    ThisNotAJoke result = new ThisNotAJoke();
    initialize(result);
    return result;
  }

  public class ThisNotAJoke extends MyApiRequest<com.example.fm.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "thisNotAJoke";

    /**
     * Create a request for the method "thisNotAJoke".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link ThisNotAJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * ThisNotAJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected ThisNotAJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.fm.myapplication.backend.myApi.model.MyBean.class);
    }

    @Override
    public ThisNotAJoke setAlt(java.lang.String alt) {
      return (ThisNotAJoke) super.setAlt(alt);
    }

    @Override
    public ThisNotAJoke setFields(java.lang.String fields) {
      return (ThisNotAJoke) super.setFields(fields);
    }

    @Override
    public ThisNotAJoke setKey(java.lang.String key) {
      return (ThisNotAJoke) super.setKey(key);
    }

    @Override
    public ThisNotAJoke setOauthToken(java.lang.String oauthToken) {
      return (ThisNotAJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public ThisNotAJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ThisNotAJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ThisNotAJoke setQuotaUser(java.lang.String quotaUser) {
      return (ThisNotAJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public ThisNotAJoke setUserIp(java.lang.String userIp) {
      return (ThisNotAJoke) super.setUserIp(userIp);
    }

    @Override
    public ThisNotAJoke set(String parameterName, Object value) {
      return (ThisNotAJoke) super.set(parameterName, value);
    }
  }
